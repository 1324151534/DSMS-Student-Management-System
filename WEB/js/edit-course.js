...
function getCourseInfo() {
    fetch('http://127.0.0.1:5000/courses/' + course_id , {
        ...
        .then(data => {
            document.getElementById("stu-name").value = data.course_name;
            document.getElementById("stu-class").value = data.courses_year;
            document.getElementById("stu-nature").value = data.nature;
            document.getElementById("stu-major").value = data.major_name;
            document.getElementById("stu-coursename").value = data.credits;
        });
}
